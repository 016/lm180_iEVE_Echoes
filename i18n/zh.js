    ...
    quickTableOreView:{
      ...
      table:{
        title:{
          o_title: '名称',
          o_volumn: '体积',
          o_volumn_price: '原矿单价/m<sup>3</sup>',
          o_volumn_price_e: '<b>原矿单价/m<sup>3</sup></b>: 根据原矿市场价格, 计算出一个立方原矿的价格',
          m_volumn_price: '矿物单价/m<sup>3</sup>',
          m_volumn_price_e: '<b>矿物单价/m<sup>3</sup></b>: 根据原矿市场价格, 计算出一个立方原矿提炼矿物的价格',
          o_asteroidLv: '小行星带',
          o_safeLv: '安全等级',
          o_: '',
        }
