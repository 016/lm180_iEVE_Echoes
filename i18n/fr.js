const messages =  {
  ...
  common:{
    ...
    costCurrency: 'ISK',
    costCharge: '<span>Actuellement, la phase de test est sur invitation uniquement. Le coût de publication des information est fixé à un montant extrêmement bas et sera restauré à la normale après. Les comptes invités reçoivent des ISK à des fins de test.</span><br/><span>Afin d\'éviter les spams, un certain montant d\'ISK sera facturé pour le message publié, et il ne peux pas être posté si le solde est insuffisant</span><br/><span>[PAS ENCORE IMPLÉMENTÉ]Méthode de recharge: envoyer des ISK par contrat à ieve dans le jeu, ajoutez `ieve-Nom de votre compte sur ieve` (pour moi c\'est ieve-DP, votre nom de compte enregistré sur ieve est très important!!!) dans la partie desc, rechargera le compte après avoir reçu le contrat</span><br/><span>Il est interdit de posté des sujets politiques, des insultes personnelles, RMT, et d\'autres contenus inappropriés. De tels postes seront supprimés sans remboursement. Toute future violation entrainera une interdiction de compte sans rmboursement.</span>',
